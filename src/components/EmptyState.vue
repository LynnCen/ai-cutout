<template>
  <div class="text-center py-16">
    <div class="relative">
      ...
      <div
        class="absolute top-0 left-1/2 transform -translate-x-1/2 w-32 h-32 bg-gradient-to-r from-blue-200/30 to-purple-200/30 rounded-full animate-pulse"
      ></div>
    </div>
    <h3 class="text-lg font-medium text-gray-900 mb-2">暂无处理结果</h3>
    <p class="text-gray-500 mb-6 max-w-sm mx-auto">
      选择预设图片或上传自己的图片，然后点击"开始抠图"按钮，处理结果将显示在这里
    </p>
