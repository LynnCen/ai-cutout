<template>
  <div class="bg-white/70 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200/50 p-6">
    ...
    <div class="space-y-4">
      ...
      <div class="text-xs text-gray-500 text-center">使用AI算法进行智能抠图处理</div>
    </div>
  </div>
</template>
