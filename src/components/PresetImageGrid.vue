<template>
  <div class="space-y-4">
    ...
    <div v-if="selectedImage" class="mt-4 p-4 bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200/50 rounded-xl">
      <div class="flex items-center space-x-3">
        ...
        <div>
          ...
          <p class="text-xs text-gray-600">{{ selectedImage.name }} · {{ getTypeLabel(selectedImage.type) }}</p>
        </div>
      </div>
    </div>
  </div>
