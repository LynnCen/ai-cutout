<template>
  <div class="space-y-6">
    ...
    >
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="space-y-3">
          ...
          <div class="relative group">
            ...
            />
            <div
              class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-10 transition-opacity rounded-lg"
            ></div>
          </div>
        </div>
      ...
      <!-- 结果信息 -->
      <div
        class="mt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-3 sm:space-y-0"
      >
